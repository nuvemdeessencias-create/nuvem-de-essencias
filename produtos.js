const meusProdutos = [ 
    // --- PERFUMES E KITS ---
    {
        ...
        secao: "alta",
        opcoes: [{ texto: "80ML", valor: "80ml|239.00", estoque: 1, disponivel: true, promoPix: false }]
    },
    {
        id: "rojo",
        marca: "SHAKIRA",
        ...
        secao: "alta",
        opcoes: [{ texto: "80ML", valor: "80ml|239.00", estoque: 5, disponivel: true, promoPix: false }]
    },
    {
        id: "shakira-ama",
        marca: "SHAKIRA",
        ...
        secao: "alta",
        opcoes: [{ texto: "80ML", valor: "80ml|239.00", estoque: 0, disponivel: false, promoPix: false }]
    },
    {
        id: "chloe",
        marca: "CHLOE",
        ...
        opcoes: [
            ...
            { texto: "75ML", valor: "75ml|939.00", estoque: 0, disponivel: false, promoPix: false }
        ]
    },
    {
        id: "gabriela",
        ...
        secao: "alta",
        opcoes: [{ texto: "60ML", valor: "60ml|169.00", estoque: 2, disponivel: true, promoPix: false }]
    },
    {
        id: "lady",
        marca: "PACO RABANNE",
        ...
        secao: "alta",
        opcoes: [{ texto: "80ML", valor: "80ml|869.00", estoque: 4, disponivel: true, promoPix: false }]
    },
    {
        id: "invictus",
        marca: "PACO RABANNE",
        ...
        secao: "alta",
        opcoes: [{ texto: "100ML", valor: "100ml|0.00", estoque: 0, disponivel: false, promoPix: false }]
    },
    {
        id: "diamond",
    ...
    },
    {
        ...
        secao: "alta",
        opcoes: [{ texto: "100ML", valor: "100ml|598.00", estoque: 5, disponivel: true, promoPix: false }]
    },
    {
        id: "animale-m",
        marca: "ANIMALE",
        ...
        secao: "alta",
        opcoes: [{ texto: "100ML", valor: "100ml|478.00", estoque: 4, disponivel: true, promoPix: false }]
    },
    {
        id: "silver",
        ...
        secao: "alta",
        opcoes: [{ texto: "100ML", valor: "100ml|399.00", estoque: 6, disponivel: true, promoPix: false }]
    },
    {
        id: "ckone",
        marca: "CALVIN KLEIN",
        ...
        secao: "alta",
        opcoes: [{ texto: "100ML", valor: "100ml|589.00", estoque: 6, disponivel: true, promoPix: true }]
    },
    {
        id: "azahar",
        ...
        secao: "alta",
        opcoes: [{ texto: "120ML", valor: "120ml|369.00", estoque: 4, disponivel: true, promoPix: false }]
    },
    {
        id: "hugomen",
        marca: "HUGO BOSS",
        ...
        secao: "alta",
        opcoes: [{ texto: "75ML", valor: "75ml|479.00", estoque: 1, disponivel: true, promoPix: false }]
    },
    {
        id: "blue",
        ...
        secao: "alta",
        opcoes: [{ texto: "80ML", valor: "80ml|249.00", estoque: 3, disponivel: true, promoPix: false }]
    },
    {
        id: "icon",
        marca: "ANTONIO BANDEIRAS",
        nome: "THE ICON EDP",
        descricao: "Uma fragrância para quem alcançou o success. Abre com pimenta preta e toranja, coração de lavanda e fundo amadeirado de musgo. Elegante, maduro e duradouro.",
        imagem: "img/theicon.webp",
        secao: "alta",
        opcoes: [{ texto: "200ML", valor: "200ml|379.00", estoque: 2, disponivel: true, promoPix: false }]
    },
    {
        id: "power",
        marca: "ANTONIO BANDEIRAS",
    ...
    },
    {
        ...
        secao: "alta",
        opcoes: [{ texto: "50ML", valor: "50ml|249.00", estoque: 7, disponivel: true, promoPix: false }]
    },
    {
        id: "clubblack",
        marca: "MERCEDES BENZ",
    ...
    },
    {
        ...
        secao: "alta",
        opcoes: [{ texto: "125ML", valor: "125ml|289.00", estoque: 1, disponivel: true, promoPix: false }]
    },
    {
        id: "nautica",
        marca: "NAUTICA",
        ...
        secao: "alta",
        opcoes: [{ texto: "100ML", valor: "100ml|199.00", estoque: 1, disponivel: true, promoPix: false }]
    },
    {
        id: "sabah",
        marca: "AL WATANIAH",
        ...
        secao: "arabe",
        opcoes: [{ texto: "100ML", valor: "100ml|359.00", estoque: 5, disponivel: true, promoPix: false }]
    },
    {
        id: "bareeq",
        marca: "AL WATANIAH",
        ...
        secao: "arabe",
        opcoes: [{ texto: "100ML", valor: "100ml|359.00", estoque: 3, disponivel: true, promoPix: false }]
    },
    {
        id: "fakhar",
        marca: "LATTAFA",
        ...
        secao: "arabe",
        opcoes: [{ texto: "100ML", valor: "100ml|439.00", estoque: 1, disponivel: true, promoPix: false }]
    },
    {
        id: "asad-lattafa",
        marca: "LATTAFA",
        ...
        secao: "arabe",
        opcoes: [{ texto: "100ML", valor: "100ml|369.00", estoque: 3, disponivel: true, promoPix: false }]
    },
    {
        id: "kitamarillo",
        marca: "SHAKIRA",
        ...
        secao: "kits",
        opcoes: [{ texto: "80ML+10ML", valor: "80ml+10ml|259.00", estoque: 6, disponivel: true, promoPix: false }]
    },
    {
        id: "coffretfucsia",
        marca: "SHAKIRA",
        ...
        secao: "kits",
        opcoes: [{ texto: "80ML+CREME", valor: "80ml+Creme|259.00", estoque: 1, disponivel: true, promoPix: false }]
    },
    {
        id: "kitblue",
        marca: "ANTONIO BANDEIRAS",
        ...
        secao: "kits",
        opcoes: [{ texto: "80ML+DESOD.", valor: "80ml+DES|259.00", estoque: 1, disponivel: true, promoPix: false }]
    },

    // --- SEÇÃO DE BATONS (INDISPONÍVEIS) ---
    {
        id: "batom-maybelline",
        marca: "MAYBELLINE",
        nome: "BATOM SUPERSTAY MATTE INK",
        descricao: "Batom líquido de longa duração com acabamento matte impecável que dura até 16 horas. Não transfere e mantém a cor vibrante.",
        imagem: "img/batom-maybelline-principal.jpg",
        secao: "maquiagem",
        opcoes: [
            { texto: "COR 15 - LOVER", valor: "lover|89.00", estoque: 0, disponivel: false, imagemCor: "img/maybelline-15.jpg", promoPix: true },
            { texto: "COR 20 - PIONEER", valor: "pioneer|89.00", estoque: 0, disponivel: false, imagemCor: "img/maybelline-20.jpg", promoPix: true }
        ]
    },
    {
        id: "batom-eudora",
        marca: "EUDORA",
        nome: "BATOM GLAM MATTE BLUR",
        descricao: "O conforto do primer com a alta pigmentação do batom matte. Tecnologia de segunda pele que não resseca os lábios.",
        imagem: "img/batom-eudora-principal.jpg",
        secao: "maquiagem",
        opcoes: [
            { texto: "VERMELHO FORMIDÁVEL", valor: "vermelho|65.00", estoque: 0, disponivel: false, imagemCor: "img/eudora-vermelho.jpg", promoPix: false }
        ]
    },
    {
        id: "batom-marykay",
        marca: "MARY KAY",
        nome: "BATOM MATTE AT PLAY",
        descricao: "Acabamento matte instantâneo, fácil aplicação e cores intensas que seguem as últimas tendências de moda mundiais.",
        imagem: "img/batom-marykay-principal.jpg",
        secao: "maquiagem",
        opcoes: [
            { texto: "RED SIREN", valor: "redsiren|49.00", estoque: 0, disponivel: false, imagemCor: "img/mk-red.jpg", promoPix: false }
        ]
    },

    // --- SEÇÃO DE VELAS (INDISPONÍVEIS) ---
    {
        id: "vela-premium",
        marca: "NUVEM ESSÊNCIAS",
        nome: "VELA AROMÁTICA DE LUXO",
        descricao: "Velas artesanais feitas com um blend de ceras vegetais e essências premium para criar um ambiente de relaxamento e sofisticação.",
        imagem: "img/vela-principal.jpg",
        secao: "velas",
        opcoes: [
            { texto: "LAVANDA FRANCESA - 120G", valor: "lavanda|55.00", estoque: 0, disponivel: false, imagemCor: "img/vela-lavanda.jpg", promoPix: false },
            { texto: "ALECRIM VIBRANTE - 120G", valor: "alecrim|55.00", estoque: 0, disponivel: false, imagemCor: "img/vela-alecrim.jpg", promoPix: false }
        ]
    }
];
